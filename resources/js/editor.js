...
registerBlockVariation('core/button', {
	name: 'slightly/button-toggle-color-scheme',
	title: __('Toggle: Light/Dark', 'slightly-blocked'),
	description: __('Toggle button for switching between light and dark mode.', 'slightly-blocked'),
	icon: (
	...
	attributes: {
		...
		tagName: 'button',
		text: `<span class="screen-reader-text">${__('Toggle Color Scheme', 'slightly-blocked')}</span>`
	},
